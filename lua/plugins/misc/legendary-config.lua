...
local keymaps = {
    ...
    -- Lspsaga
    { "gh", ":Lspsaga lsp_finder<CR>", description = "LSP Finder", mode = "n", opts = opts },
    { "gg", ":Lspsaga code_action<CR>", description = "Code Action", mode = "n", opts = opts },
    { "gj", ":Lspsaga hover_doc<CR>", description = "Hover Doc", mode = "n", opts = opts },
    { "gk", ":Lspsaga signature_help<CR>", description = "Signature Help", mode = "n", opts = opts },
    { "gl", ":Lspsaga show_line_diagnostics<CR>", description = "Show Line Diagnostics", mode = "n", opts = opts },
    { "gq", ":Lspsaga rename<CR>", description = "Rename", mode = "n", opts = opts },
    { "gR", ":Lspsaga preview_definition<CR>", description = "Preview Definition", mode = "n", opts = opts },

    -- Other configurations
    { "<C-j>", ":OtherVSplit<CR>", description = "Other Split", mode = "n", opts = opts },
    { "<C-[>", ":Mason<CR>", description = "Mason", mode = "n", opts = opts },
    { "<C-l>", ":ToggleTerm<CR>", description = "Toggle Terminal", mode = "n", opts = opts },
